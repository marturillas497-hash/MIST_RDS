...
/**
 * Sends an account activation email to a newly approved research adviser.
 * @param {Object} params
 * @param {string} params.email - The adviser's email address
 * @param {string} params.fullName - The adviser's full name
 */
export async function sendAdviserApprovalEmail({ email, fullName }) {
  ...
  if (error) {
    // Log the error but do not throw, approval should not fail if email fails
